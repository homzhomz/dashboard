<%@ Page Language="C#" AutoEventWireup="true" codefile="mes_031.aspx.cs" Inherits="Situation_Center.web.mes_031" %>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row" id="row1">
            <div class="col-md-2"><div class="box-content">WIC-A401</div><div id="mach_no1" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-A402</div><div id="mach_no2" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1301</div><div id="mach_no3" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1302</div><div id="mach_no4" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1303</div><div id="mach_no5" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1304</div><div id="mach_no6" class="box"></div></div>
        </div>

        <div class="row" id="row2">
            <div class="col-md-2"><div class="box-content">WIC-1305</div><div id="mach_no7" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-2301</div><div id="mach_no8" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-2302</div><div id="mach_no9" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-2303</div><div id="mach_no10" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-3301</div><div id="mach_no11" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-3302</div><div id="mach_no12" class="box"></div></div>
        </div>

        <div class="row" id="row3">
            <div class="col-md-2"><div class="box-content">WIC-3303</div><div id="mach_no13" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-3304</div><div id="mach_no14" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-3305</div><div id="mach_no15" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-3306</div><div id="mach_no16" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1C01</div><div id="mach_no17" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1C02</div><div id="mach_no18" class="box"></div></div>
        </div>

        <div class="row" id="row4">
            <div class="col-md-2"><div class="box-content">WIC-1C03</div><div id="mach_no19" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1C04</div><div id="mach_no20" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1C05</div><div id="mach_no21" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-1C06</div><div id="mach_no22" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-5C01</div><div id="mach_no23" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-5C02</div><div id="mach_no24" class="box"></div></div>
        </div>

        <div class="row" id="row5">
            <div class="col-md-2"><div class="box-content">WIC-5C03</div><div id="mach_no25" class="box"></div></div>
            <div class="col-md-2"><div class="box-content">WIC-5C04</div><div id="mach_no26" class="box"></div></div>
        </div>
    </div>
                    ...
                    for (var i = 0; i < data.length; i++) {
                        switch (data[i].e_tank_area_id) {
                            ...
                            case 'WIC-1C02':
                                mach_no = $("#mach_no18");
                                if ((Date.parse(data[i].step_finish_datetime)).valueOf() < (Date.parse(CurrentDate)).valueOf()) {
                                    $('#mach_no18').css({ 'background-color': '#6C272C' });
                                }
                                else {
                                    $('#mach_no18').css({ 'background-color': '#054D0C' });
                                }
                                break;
                            case 'WIC-1C03':
                                mach_no = $("#mach_no19");
                                if ((Date.parse(data[i].step_finish_datetime)).valueOf() < (Date.parse(CurrentDate)).valueOf()) {
                                    $('#mach_no19').css({ 'background-color': '#6C272C' });
                                }
                                else {
                                    $('#mach_no19').css({ 'background-color': '#054D0C' });
                                }
                                break;
                            case 'WIC-1C04':
                                mach_no = $("#mach_no20");
                                if ((Date.parse(data[i].step_finish_datetime)).valueOf() < (Date.parse(CurrentDate)).valueOf()) {
                                    $('#mach_no20').css({ 'background-color': '#6C272C' });
                                }
                                else {
                                    $('#mach_no20').css({ 'background-color': '#054D0C' });
                                }
                                break;
                            case 'WIC-1C05':
                                mach_no = $("#mach_no21");
                                if ((Date.parse(data[i].step_finish_datetime)).valueOf() < (Date.parse(CurrentDate)).valueOf()) {
                                    $('#mach_no21').css({ 'background-color': '#6C272C' });
                                }
                                else {
                                    $('#mach_no21').css({ 'background-color': '#054D0C' });
                                }
                                break;
                            case 'WIC-1C06':
                                mach_no = $("#mach_no22");
                                if ((Date.parse(data[i].step_finish_datetime)).valueOf() < (Date.parse(CurrentDate)).valueOf()) {
                                    $('#mach_no22').css({ 'background-color': '#6C272C' });
                                }
                                else {
                                    $('#mach_no22').css({ 'background-color': '#054D0C' });
                                }
                                break;
                            case 'WIC-5C01':
                                mach_no = $("#mach_no23");
                                if ((Date.parse(data[i].step_finish_datetime)).valueOf() < (Date.parse(CurrentDate)).valueOf()) {
                                    $('#mach_no23').css({ 'background-color': '#6C272C' });
                                }
                                else {
                                    $('#mach_no23').css({ 'background-color': '#054D0C' });
                                }
                                break;
                            case 'WIC-5C02':
                                mach_no = $("#mach_no24");
                                if ((Date.parse(data[i].step_finish_datetime)).valueOf() < (Date.parse(CurrentDate)).valueOf()) {
                                    $('#mach_no24').css({ 'background-color': '#6C272C' });
                                }
                                else {
                                    $('#mach_no24').css({ 'background-color': '#054D0C' });
                                }
                                break;
                            case 'WIC-5C03':
                                mach_no = $("#mach_no25");
                                if ((Date.parse(data[i].step_finish_datetime)).valueOf() < (Date.parse(CurrentDate)).valueOf()) {
                                    $('#mach_no25').css({ 'background-color': '#6C272C' });
                                }
                                else {
                                    $('#mach_no25').css({ 'background-color': '#054D0C' });
                                }
                                break;
                            case 'WIC-5C04':
                                mach_no = $("#mach_no26");
