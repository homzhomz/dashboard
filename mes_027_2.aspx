<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mes_027_2.aspx.vb" Inherits="mes_027_2" %>
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (i == 0) {
                            ...
                            for (key in table_head) {
                                if (key == '工單') {
                                    tr.append('<th class="text-center">' + key + '<span id="version"><a href="mes_027.aspx">TTP</a></span></th>');
                                }
                                else {
